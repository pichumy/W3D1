...
def sparse_continents
  ...
  # population.
  # Find a continent where all countries have less than 25,000,000 in population
  # Find country with less than 25,000,000 population
  # Then, find continent where the number of countries with more than 25,000,000 population is zero
  # Then, return those countries
